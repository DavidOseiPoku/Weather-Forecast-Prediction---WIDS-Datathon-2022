...
Dataset Description
Within this folder you will find 2 files. The other 2 files directly related to the project's implementation are can be obtained from the following link: https://www.kaggle.com/competitions/widsdatathon2022/data . The following are the 2 files contained in this folder :
